#!/bin/sh
# Alpine Linux 128MB VPS 部署脚本

set -e

echo "=== 聊天室部署脚本 (Alpine Linux) ==="
echo "适用于 128MB 内存的 NAT VPS"
...
# 创建 systemd 服务（如果可用）或 openrc 服务
cat > /etc/init.d/chatroom << 'EOF'
#!/sbin/openrc-run

description="Lightweight Chatroom"
...
echo "  4. 访问: http://your-vps-ip:8080"
echo ""
echo "或者直接运行:"
